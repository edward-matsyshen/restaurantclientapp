...
document.addEventListener("DOMContentLoaded", function () {
    ...
    {
        $.get("https://kurtlistenandwrite.azurewebsites.net", function(data, status){  });
    }
...
function postnew() {
    ...
    $.ajax({
    	// run locally
         //url : "http://localhost:7071/api/kurtwritetops",
        
        //write to local copy of writeToSub
        ...
        url : "https://kurtwritetops01.azurewebsites.net/api/kurtwritemongo",
...
function createList(which, city) {
    ...
    // run in cloud
    // $.get("https://kurtcosmosdatawrite.azurewebsites.net/api/kurtwritecosmos?name="+ param, function(data, status){
    $.get("https://kurtmongoreader01.azurewebsites.net/api/kurtreadmongo?name="+ param, function(data, status){
     // run local
    //$.get("http://localhost:7071/api/kurtwritecosmos?name=" + param, function(data, status){ 
